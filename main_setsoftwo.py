...
done running the code. This file is used to work with sets of 2 scenes per datapoint.
"""
...
if __name__ == "__main__":
    ...
    # calculate correlation between methane and support variable(s). Hardcode define which supportvariables are used.
